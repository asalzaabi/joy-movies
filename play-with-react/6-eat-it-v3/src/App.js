  ...
  state = {
    ...
    items: [
      ...
      },
      {
        id: 2,
        name: "War",
        desc: "Hindi PG15 Action 2Hrs 30mins",
      ...
      },
      {
        id: 3,
        name: "Abominable",
        desc: "EnglishGAnimation | Adventure | Comedy1Hr 32mins",
      ...
      },
      {
        ...
        desc: "English GAdventure | Comedy1Hr 26mins",
      ...
      },
      {
        id: 5,
        name: "Ad Astra",
        desc: "English PGSci-Fi | Thriller2Hrs 3mins",
          ...
          <div>
            <div className="container">
              <ul className="nav nav-pills">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/ComingS">
                    Coming soon
                  </Link>
                </li>
                <li className="nav-item">
